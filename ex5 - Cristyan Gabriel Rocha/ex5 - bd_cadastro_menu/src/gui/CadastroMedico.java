...
public class CadastroMedico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        especField.setFont(new java.awt.Font("Consolas", 0, 16)); // NOI18N
    ...
    private void btnCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroActionPerformed
        ...
        med.setNome_medico(nomeField.getText());
        med.setCpf_medico(cpfField.getText());
        med.setIdade_medico(idadeField.getText());
        med.setTell_medico(tellField.getText());
        med.setCidade_medico(cidadeField.getText());
        med.setEspecialidade_medico(especField.getText());
        
        if(nomeField.getText().isEmpty() || cpfField.getText().isEmpty() || idadeField.getText().isEmpty() ||tellField.getText().isEmpty() || cidadeField.getText().isEmpty() || especField.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null,"Medico " + nomeField.getText() + " cadastrado com sucesso.");
